...
import { friendRequestLimiter } from '../middlewares/rateLimiter.js';

const router = Router();

// Send a friend request
router.post('/request', friendRequestLimiter, validate(sendFriendRequestSchema), asyncHandler(FriendsController.sendRequest));
