...
const NORMS = {
  ...
  Neuroticism: { mean: 2.9, stdDev: 0.75 },
  Agreeableness: { mean: 3.6, stdDev: 0.6 },
  Conscientiousness: { mean: 3.4, stdDev: 0.65 },
  Openness: { mean: 3.7, stdDev: 0.65 },
};
const CENTROIDS = {
  ...
  'Secure Optimist': [0.107, -0.217, 0.081, 0.06, -0.098],
};
