...
/**
 * LESSON: Middleware Pattern
 *
 * Express middleware is a function that sits between the request and your route handler.
 * It can:
 * 1. Inspect/modify the request
 * 2. Inspect/modify the response
 ...
 *
 * Our validate middleware will:
 * 1. Take the incoming request body
 * 2. Validate it against a Zod schema
 * 3. If valid: attach cleaned data to req.body and call next()
 * 4. If invalid: send a 400 error response with detailed messages
 */
