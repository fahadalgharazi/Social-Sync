 ...
 * Without this, jest.setTimeout() and afterAll() won't work
 */
...
/**
 * LESSON: Why Mock External Services?
 *
 * Real APIs in tests are bad because:
 * 1. Tests become slow (network requests)
 * 2. Tests become flaky (network issues)
 * 3. Tests cost money (API rate limits)
 * 4. Tests have side effects (creating real users!)
 * 5. Tests depend on external state
 *
 * Mocks let us control exactly what the "API" returns,
 * making tests fast, reliable, and free!
 */
