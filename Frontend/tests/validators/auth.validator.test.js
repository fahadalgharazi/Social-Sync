// Frontend/tests/validators/auth.validator.test.js
import { describe, it, expect } from 'vitest'
import { loginSchema, signupSchema } from '../../src/validators/auth.validator'

/**
 * LESSON: Frontend Validation Testing
 *
 * These tests verify our Zod schemas work correctly BEFORE
 * sending data to the backend. This catches user input errors early.
 *
 * We test:
 * - Valid data passes ✓
 * - Invalid data fails with proper errors ✗
 * - Transformations work (trim, lowercase, etc.)
 */
