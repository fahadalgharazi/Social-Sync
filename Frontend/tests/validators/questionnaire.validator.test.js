// Frontend/tests/validators/questionnaire.validator.test.js
import { describe, it, expect } from 'vitest'
import { questionnaireSchema } from '../../src/validators/questionnaire.validator'

/**
 * LESSON: Testing Complex Nested Validation
 *
 * Questionnaires have nested structure with strict requirements:
 * - 5 traits, each with exactly 3 answers
 * - Answers must be 1-5 (Likert scale)
 * - Optional open-ended response (max 2000 chars)
 */
