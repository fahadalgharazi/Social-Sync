          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-center items-center h-20 relative">
              ...
              <div className="hidden md:flex items-center space-x-8 mx-auto">
                <Button
                  variant="ghost"
                  className="text-gray-700 hover:text-indigo-600 hover:bg-indigo-50/70 rounded-xl px-6"
                >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white/95 backdrop-blur-xl border-b border-gray-100 shadow-lg">
            <div className="px-4 py-6 space-y-4">
              <Button
                variant="ghost"
                className="w-full justify-start text-gray-700 hover:text-indigo-600 hover:bg-indigo-50/70 rounded-xl"
              >
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link to={"/events"}>
                <Button
                  variant="ghost"
                  className="text-base text-gray-700 hover:text-indigo-700 hover:bg-indigo-50/50 [&>svg]:!size-7"
                >
