        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>
                <button className="hover:text-indigo-600 transition-colors">Events</button>
              </li>
              <li>
                <button className="hover:text-indigo-600 transition-colors">Community</button>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li>
                <button className="hover:text-indigo-600 transition-colors">Help Center</button>
              </li>
              <li>
                <button className="hover:text-indigo-600 transition-colors">Contact Us</button>
              </li>
              <li>
                <button className="hover:text-indigo-600 transition-colors">Status</button>
              </li>
              <li>
                <button className="hover:text-indigo-600 transition-colors">Updates</button>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>
                <button className="hover:text-indigo-600 transition-colors">Guidelines</button>
              </li>
            </ul>
          </div>
        </div>
